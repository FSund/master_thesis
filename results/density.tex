\section{Density of water\label{sec:results_first_sec}}
...
\begin{figure}[!htb]%
    ...
    \makebox[\textwidth][c]{ % to center figures below that are wider than \textwidth
        \begin{minipage}[t]{\myfigwidth}%
            ...
            \subcaption{%
                Dashed lines are 14.4 \AA\ (red, \#3) and 28.8 \AA\ (teal, \#4) narrow flat pores, solid lines are 86 \AA\ wide flat pores.%
        ...
        \begin{minipage}[t]{\myfigwidth}%
            ...
            \subcaption{%
                Dashed lines are 14.4 \AA\ (red, \#3) and 28.8 \AA\ (teal, \#4) narrow fractures, solid lines are random fractures.%
...
\todobo{More about these two figures?}

\subsubsection*{Filling density vs. actual density}
