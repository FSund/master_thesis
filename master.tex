...
\includeonly{introduction,molecular_dynamics/introduction,results/introduction,results/results,results/discussion,results/conclusion}
...
%     \include{molecular_dynamics/optimizations} % Moved cell lists to md part, removed MD units stuff
...
% \part{Conclusion and future}
    \include{results/conclusion}
%     \include{results/future}

\part{Appendices}
\begin{appendix}
%     \include{appendices/md_units} % remove md units completely?
    \include{appendices/integrators}
    \include{appendices/nose_hoover}
%     \include{appendices/pressure} % haven't measure pressure, and haven't derived it either
\end{appendix}
