...
% To control how LATEX counts the listing floats, you can pass either the section
% chapter or chapter option when loading the minted package. For example, the following
% will cause listings to be counted per-section:
