...
\input{preamble/other_packages.tex}
...
% Decide on font size for includesvg (now it's \footnotesize)
...
% \includeonly{molecular_dynamics/experimental_procedure,molecular_dynamics/measurements,results/systems,results/results}
\includeonly{molecular_dynamics/simple_md_program,molecular_dynamics/ensembles,appendices/nose_hoover}
...
\begin{appendix}
    ...
    \include{appendices/nose_hoover}
