...
\begin{figure}[htpb]%
\centering%
\includesvg[width=0.4\textwidth, svgpath=./images/voronoi/]{2d_diagram03}%
\caption{%
    \hl{Caption}. %
...
\centering%
    \includegraphics[width=0.7\textwidth]{images/voronoi/import_AM2_A001.png}%
    \subcaption{Caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption }%
%     \label{fig:sample_figure}%
\end{minipage}%
\hspace{0.03999\textwidth}%
\begin{minipage}[t]{0.48\textwidth}%
\centering%
    \includegraphics[width=0.7\textwidth]{images/voronoi/import_AM2_A001.png}%
    \subcaption{Caption for image caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption caption }%
%     \label{fig:sample_figure}%
\end{minipage}%
\end{figure}%
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{images/voronoi/import_AM2_A001.png}
  \captionof{figure}{aaaaaaaaaaa aaaa aaaaa aaaaaaaaaaa aaaa aaaaa aaaaaaaaaaa aaaa aaaaa aaaaaaaaaaa aaaa aaaaa aaaaaaaaaaa aaaa aaaaa aaaaaaaaaaa aaaa aaaaa aaaaaaaaaaa aaaa aaaaa }
  \label{fig:test2}
\end{minipage}
\end{figure}
...
% \centering%
    ...
    \begin{minipage}[b]{0.4999\textwidth}%
        ...
        \centering%
        \includesvg[width=\textwidth, svgpath=./images/voronoi/]{2d_diagram03}%
        \caption{%
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Ut purus elit, vestibulum ut, placerat ac, adipiscing vitae, felis. Curabitur dictum gravida mauris. Nam arcu libero, nonummy eget, consectetuer id, vulputate a, magna.%
            \label{fig:b}%
        }%
