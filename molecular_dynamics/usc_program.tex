\chapter{Molecular dynamics program/code used for experiments}
...
The program implements both the fast and simple Berendsen thermostat, and the more sophisticated Nos\'e-Hoover chains thermostat.
...
The program utilizes the fact that the vibrational frequency in water is much higher than the frequency of silica, which means that we can use larger timesteps to integrate the motions of the silica molecules than the water molecules.
% %
% \begin{figure}[htpb]%
%     \centering%
