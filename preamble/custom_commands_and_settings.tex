...
\newcommand{\matlab}{\mono{Matlab}}

% ---- Font ---- %
% \newcommand*{\selectmono}{\fontfamily{fdm}\selectfont}
% \newcommand{\mono}[1]{{\selectmono#1}}

% \newcommand{\mono}[1]{{\small\fdmfamily#1}}
\newcommand{\mono}[1]{{\fdmfamily#1}} % changed scale of droidmono to 0.8 instead of 0.85, so now we don't need \small
