...
% ---- Todo colors ---- %
\newcommand{\todoa}[1]{\todo[inline,color=red!70]{#1}}
\newcommand{\todob}[1]{\todo[inline,color=blue!50]{#1}}
\newcommand{\todoc}[1]{\todo[inline,color=green!50]{#1}}
\newcommand{\todod}[1]{\todo[inline,color=pink]{#1}}

\newcommand{\todoao}[1]{\todo[color=red!70]{#1}}
\newcommand{\todobo}[1]{\todo[color=blue!50]{#1}}
\newcommand{\todoco}[1]{\todo[color=green!50]{#1}}
\newcommand{\tododo}[1]{\todo[color=pink]{#1}}
